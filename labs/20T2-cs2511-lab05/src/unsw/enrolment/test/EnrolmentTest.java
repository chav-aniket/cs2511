...
import unsw.enrolment.CalculatedGrade;
...
public class EnrolmentTest {
    ...
    public static void main(String[] args) {
        ...
        Log log1511 = new Log(comp1511Enrolment);
        ...
        Log log1531 = new Log(comp1531Enrolment);
    ...
    //    comp1511Enrolment.assignMark(65);
        ...
        Grade ass1 = new Grade("Assignment 1", 65);
        comp1511Enrolment.assignMark(ass1);

        // TODO Give the student a passing mark for milestone 1 of assignment 2
        Grade milestone1 = new Grade("Assignment 2 Milestone 1", 60);
        comp1511Enrolment.assignMark(milestone1);

        // TODO Give the student a passing mark for milestone 2 of assignment 2
        Grade milestone2 = new Grade("Assignment 2 Milstone 2", 70);
        comp1511Enrolment.assignMark(milestone2);

        // TODO Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        CalculatedGrade ass2 = new CalculatedGrade("Assignment 2", milestone1);
        ass2.addMark(milestone2);
        comp1511Enrolment.assignMark(ass2);

        // TODO Give the student a prac mark which is the sum of assignment 1
        // and 2
        Grade prac = new Grade("Prac", ass1.getMark() + ass2.getMark());
        comp1511Enrolment.assignMark(prac);

        // TODO Give the student a passing exam mark.
        Grade exam = new Grade("Exam", 51);
        ...
        Log log2511 = new Log(comp2521Enrolment);
